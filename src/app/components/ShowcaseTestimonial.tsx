...
export default function ShowcaseTestimonial() {
  ...
  return (
    <section className="relative w-full overflow-hidden ">
          ...
          <div className="rounded-2xl shadow-lg overflow-hidden bg-white">
            <div className="grid lg:flex">
              ...
              <div className="relative min-h-80 h-full md:min-h-56 flex justify-between items-center bg-secondary text-white w-full">
                ...
                <div className="relative p-6 sm:p-8 lg:p-10 text-center md:text-start">
                  <h3 className="text-3xl font-bold">
                    Trusted , Happy &amp; Satisfied Businesses
                  </h3>
                  <p className="mt-4 text-lg  leading-6 text-white/95 max-w-2xl">
                    When you work with HR Solutions, you get the best. We
                    provide adaptable solutions that allow you to be a part of
                    the entire process.
                  </p>
                </div>
              </div>
              ...
              {/* Right: Image */}
              <div className="relative hidden lg:flex bg-gray-100 w-96">
                <div className="relative w-96 h-72 sm:h-80 md:h-full">
                  <Image
      ...
      {/* top-left small png */}
      <div className="absolute  h-full w-full top-66 -z-10 bg-[#f7f7f7] flex justify-end items-start">
        <Image
